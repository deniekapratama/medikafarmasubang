...
<title><?= $title;  ?></title>
	...
	<br>
			...
			<h3><?= $title; ?></h3>
			<small><b>*</b> sewaktu-waktu dapat berubah</small>
			<br>
			<br>
	...
	<?php foreach ($jadwal_dokter as $jd){ ?>
        			<div class="col-lg-3 col-md-4 col-sm-6 ap">
        				<div class="h_gallery_item">
        					<img src="<?= base_url('assets/backend/img/dokter/') . $jd['image']; ?>" alt="">
        					<div class="hover">
        						<a href="#"><h4><?= $jd['dokter_spesialis']; ?></h4></a>
        						<a class="light" href="<?= base_url('assets/backend/img/dokter/') . $jd['image']; ?>"><i class="fa fa-expand"></i></a>
        					</div>
        				</div>
        			</div>
	<?php } ?>
